      ...
      <Container maxWidth="lg">
        <Box>
          <span>
            ...
            <Button onClick={() => history.goBack()} variant="outlined" style={{color:'#8FBC8B'}}>
              Go back
            </Button>
          </span>
        </Box>
                  ...
                  <ListItem>
                    <ListItemText
                      ...
                      secondary={
                        <span>
                          <p>
                            <strong>Items price:</strong> {Number(order.itemsPrice).toFixed(2)}Rs
                          </p>
                          <p>
                            <strong>Shipping costs:</strong> {order.shippingPrice}Rs
                          </p>
                          <p>
                            <strong>Tax costs:</strong> {order.taxPrice}Rs
                          </p>
                          <p>
